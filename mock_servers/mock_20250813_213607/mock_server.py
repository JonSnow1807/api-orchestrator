...
Timestamp: 2025-08-13T21:36:07.167463
"""
...
@app.post("/users")
async def post__users(request: Request):
    """
    POST /users
...
async def get__users_{id}(request: Request):
    """
    GET /users/{id}
...
async def delete__users_{id}(request: Request):
    """
    DELETE /users/{id}
