...
async def resolve_variables(
    ...
    return {"success": True, "original": request.text, "resolved": resolved_text}
...
async def list_variables(
    ...
    return {
        "success": True,
        "variables": [EnvironmentManager._variable_to_dict(var) for var in variables],
    }
...
async def update_variable(
    ...
    try:
        ...
        return {"success": True, "variable": updated_var}
...
async def delete_variable(
    ...
    success = EnvironmentManager.delete_variable(
        db=db, user_id=current_user.id, variable_id=variable_id
    )
...
async def bulk_update_variables(
    ...
    for var_data in variables:
        try:
            ...
            errors.append({"variable_id": var_data.get("id"), "error": str(e)})
...
async def test_variable_resolution(
    ...
    return {"success": True, "original": text, "resolutions": results}
