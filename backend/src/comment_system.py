...
class CommentSystem:
    ...
    async def update_comment(
        self, comment_id: str, content: str, editor_id: str
    ) -> Comment:
        """Update a comment"""
    ...
    async def resolve_comment(
        self, comment_id: str, resolver_id: str, resolver_name: str
    ) -> Comment:
        """Resolve a comment"""
    ...
    async def search_comments(
        ...
        for comment in self.comments.values():
            ...
            if (
                query_lower in comment.content.lower()
                or query_lower in comment.author_name.lower()
                or query_lower in comment.resource_name.lower()
            ):
    ...
    def _build_comment_tree(self, root_id: str) -> Dict[str, Any]:
        ...
        tree = {"comment": root.dict(), "replies": []}
